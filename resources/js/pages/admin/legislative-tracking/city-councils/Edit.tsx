import CityCouncilForm from '@/components/admin/legislative-tracking/city-councils/forms/council-form';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Edit City Council',
        href: '#',
    },
];

export default function Edit({ cityCouncil }: Props) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit City Council" />
            ...
            <div className="relative flex-1 gap-2 overflow-hidden border border-sidebar-border/70 p-3">
                <div className="align-self-center m-4 mx-auto w-full justify-self-center rounded-xl border p-4 md:mx-auto md:my-6 md:w-7/9">
                    ...
                    <CityCouncilForm cityCouncil={cityCouncil} />
                </div>
            </div>
        </AppLayout>
    );

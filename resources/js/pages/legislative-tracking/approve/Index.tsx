import { DataTable } from '@/components/legislative-tracking/table-tracking/approve/ossp-datatable';
import DocumentFilters from '@/components/legislative-tracking/table-tracking/approve/ossp-tracking-filter';
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
type Props = {
    approves: Paginated<LegislativeApproved>;
    filters: {
        per_page: number;
    ...
    cityCouncil: LegislativeCityCouncil[];
    years: number[];
    total_count: number;
};
...
export default function Index({
    ...
    const [selectedItem, setSelectedItem] =
        useState<LegislativeApproved | null>(null);
    const [processing, setProcessing] = useState(false);

    // Called from Actions dropdown
    const confirmDelete = (item: LegislativeApproved) => {
    ...
    const handleDelete = () => {
        ...
        router.delete(route('legislative-tracking.destroy', selectedItem.id), {
            onFinish: () => {
                setProcessing(false);
                setOpenDialog(false);
            },
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex items-center justify-between p-4">
                <Link href={route('legislative-tracking.approve.create')}>
                    <Button>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <strong>{selectedItem?.approve_no}</strong>? This
